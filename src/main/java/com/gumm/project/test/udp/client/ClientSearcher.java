...
import com.gumm.project.test.udp.ByteUtils;
import com.gumm.project.test.udp.client.bean.ServerInfo;
import com.gumm.project.test.udp.constants.UDPConstants;
...
import static com.gumm.project.test.udp.constants.UDPConstants.UDP_CONN_IP;
...
public class ClientSearcher {
    ...
    private static void sendBroadcast() throws IOException {
        ...
        // 地址
        requestPacket.setAddress(InetAddress.getByName(UDP_CONN_IP));
        // 设置服务器端口
